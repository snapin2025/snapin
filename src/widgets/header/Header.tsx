      ...
      <div className={styles.container}>
        ...
        <nav className={styles.nav}>
          <div className={styles.notificationWrapper}>
            {/* Теперь используем компонент NotificationBell */}
          ...
          <div className={styles.languageSelector}>
            ...
            >
              <rect width="20" height="20" fill="url(#pattern0_88374_127)" />
              <defs>
                <pattern id="pattern0_88374_127" patternContentUnits="objectBoundingBox" width="1" height="1">
                  <use xlinkHref="#image0_88374_127" transform="scale(0.0138889)" />
                </pattern>
                <image
                  id="image0_88374_127"
                  width="72"
