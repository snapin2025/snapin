...
export const Flag = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#Flag_svg__a)" d="M0 0h20v20H0z" />
    <defs>
      <pattern id="Flag_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#Flag_svg__b" transform="scale(.01389)" />
      </pattern>
      <image
