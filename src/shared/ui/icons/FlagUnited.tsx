...
export const FlagUnited = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#flag-united_svg__a)" d="M0 0h20v20H0z" />
    <defs>
      <pattern id="flag-united_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#flag-united_svg__b" transform="scale(.01389)" />
      </pattern>
      <image
